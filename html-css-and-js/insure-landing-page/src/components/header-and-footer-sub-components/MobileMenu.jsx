...
function MobileMenu ({ isOpen, setIsOpen }) {
    ...
    return (
        <nav className="md:hidden text-lg">
            ...
            <NavLinks 
                container={`${isOpen ? "translate-x-0 opacity-100" : "translate-x-full opacity-0"} px-8 py-16 transition duration-500 ease-in-out h-screen absolute top-full left-0 right-0 bg-[hsl(270,9%,17%)] bg-[url('/images/bg-pattern-mobile-nav.svg')] bg-cover bg-no-repeat bg-bottom flex flex-col gap-6 z-50`}
