function Intro () {
    return (
        <section className="grid max-md:grid-rows-2 md:grid-cols-2 bg-[hsl(256,26%,20%)] md:bg-[url('/images/bg-pattern-intro-right-desktop.svg')] bg-size-[400px] bg-no-repeat bg-top-right md:p-16 lg:p-32 relative z-10">
            <div className="h-full w-full md:col-start-2">
                ...
                <img className="-z-100 max-md:hidden object-cover lg:absolute lg:right-32 lg:-translate-y-1/4 lg:top-2/5 lg:w-2/5" src="/images/image-intro-desktop.jpg" alt="intro image" />
            </div>
            <div className="text-[hsl(0,0%,98%)] max-md:text-center flex flex-col gap-6 justify-center max-md:px-8 md:row-start-1 max-md:bg-[url('/images/bg-pattern-intro-left-mobile.svg')] bg-size-[250px] bg-no-repeat bg-top-left">
