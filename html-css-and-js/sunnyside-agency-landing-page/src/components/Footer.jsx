...
function Footer() {
  return (
    <footer className="bg-[hsl(167,34%,41%)] flex flex-col items-center gap-8 py-16">
      <div>
        <svg
          className="text-[hsl(167,40%,24%)]"
          width="124"
          height="24"
      ...
      <nav className="flex flex-col gap-16">
        <ul className="flex gap-4 text-[hsl(167,40%,24%)] font-medium">
          {items.map((item) => (
            <li
              className="cursor-pointer font-['Barlow'] hover:text-[hsl(0,100%,100%)] transtion duration-300 ease-in-out"
              key={item}
            >
              {item}
            </li>
          ...
          {socials.map((social) => {
            return (
              <a href={social.href} key={social.name} 
                 className="text-[hsl(167,40%,24%)] hover:text-white transition duration-300 ease-in-out cursor-pointer">
